...
class ResUNet_d6_encoder(HybridBlock):
    ...
    def __init__(self,_nfilters_init,  _NClasses,  patch_size=256, verbose=True, _norm_type = 'BatchNorm', **kwards):
        ...
        with self.name_scope():
            ...
            self.middle = PSP_Pooling(nfilters, _norm_type = _norm_type, depth=self.psp_depth)
