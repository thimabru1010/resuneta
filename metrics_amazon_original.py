def compute_metrics(thresholds, img_predicted, img_labels, mask_amazon_ts, px_area):  
    ''' INPUTS:
    ...
    for thr in thresholds:
        ...
        small_area = skimage.morphology.area_opening(img_predicted_, area_threshold = px_area, connectivity = 1)
...
metrics = compute_metrics(ProbList, img_predicted, img_labels, mask_amazon_ts, px_area)
